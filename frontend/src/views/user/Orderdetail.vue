            ...
            <div class="p-3 rounded-3" style="background:#f8f9fa;">
              ...
              <div class="mt-2">
                ...
                <span class="badge ms-1"
                  :style="methodBadgeStyle(order.paymentMethod)">
...
const methodBadgeStyle = (m) => {
  const styles = {
    COD:                   'background:#f3f4f6;color:#374151;',
    E_WALLET:              'background:#f0fdf4;color:#16a34a;',
  }
  return styles[m] || 'background:#f3f4f6;color:#374151;'
}
